...
class GenerateTicketController extends Controller
{
   use MultiActionTrait;
                               ...
                               )
	{
        ...
        $this->module_url_path          = $this->admin_url_path."/";
        $this->module_title             = "Generate Ticket";
        $this->module_view_folder       = "admin.generate_ticket";
        $this->module_icon              = "fa-ticket";
    ...
    public function store_ticket(Request $request)
    {
        ...
        if(isset($obj_guest) && $obj_guest!=null)
        {
            ...
            if($obj_guest->notification_by_push == 'on') {
                $headings = 'Ticket Submit Successfully';
