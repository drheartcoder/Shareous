        ...
        load: function() {
            ...
            optionsWrap.on('click', '.ms-selectall', function( event ){
                ...
                if( $(this).hasClass('global') ) {
                    ...
                    var optgroupLabel = optgroup.find('> .label-ht').text();
        ...
        loadOptions: function( options, overwrite, updateSelect ) {
            ...
            for( var key in options ) {
                ...
                if( thisOption.hasOwnProperty('options') ) {
                    optionsList.find('> li.optgroup > span.label-ht').each(function(){
                    ...
                    if( appendContainer ) {
                        ...
                        container.append('<span class="label-ht">'+ thisOption.label +'</span>');
                        container.find('> .label-ht').css({
                            clear: 'both'
                        });
