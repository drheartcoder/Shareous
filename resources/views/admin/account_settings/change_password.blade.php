        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-content">
                    ...
                    <form name="validation-form" id="change-password-form" class="form-horizontal" method="POST" action="{{url($admin_panel_slug.'/profile/update_password')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                                ...
                                <a href="{{url($admin_panel_slug.'/dashboard')}}" class="btn btn-cancel">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
