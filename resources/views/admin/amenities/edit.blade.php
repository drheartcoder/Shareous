    ...
    <div class="col-sm-12">
      <form name="validation-form" id="validate_form" method="POST" class="form-horizontal" action="{{url($module_url_path).'/update/'.$id}}" enctype="multipart/form-data"  files ="true">
        ...
        <div class="form-group col-lg-11">
         ...
         <div class="col-sm-5 col-lg-5 controls">
          <select class="form-control" id="propertytype_id" name="propertytype_id" data-rule-required="true">
                    ...
                    <option value="{{$propertytype['id']}}" @if($object['propertytype_id']==$propertytype['id']) selected="selected" @endif>{{$propertytype['name']}}</option>
                    @endforeach
                    @endif
            </select>
        ...
        <div class="form-group col-lg-11">
         ...
         <div class="col-sm-5 col-lg-5 controls">
          <input type="text" name="name" class="form-control" value="{{isset($object['aminity_name']) ? ucfirst($object['aminity_name']):''}}" data-rule-required="true" data-rule-maxlength="255"  placeholder="{{$module_title or ''}} Name">
