      ...
      <form name="validation-form" id="validate_form" method="POST" class="form-horizontal" action="{{url($module_url_path)}}/store" enctype="multipart/form-data"  files ="true">
        {{csrf_field()}}
          ...
          <div class="form-group col-lg-11">
              ...
              <div class="col-sm-8 col-lg-8 controls">
                  <input type="text" name="title" class="form-control" value="{{old('title')}}" data-rule-required="true" data-rule-maxlength="255"  placeholder="Enter Title">
          ...
          <div class="form-group col-lg-11">
              ...
              <div class="col-sm-10 col-lg-10 controls">
                   <textarea name="descriptions" class="form-control ckeditor" data-rule-required="true">  {{old('descriptions')}} </textarea>
                  <span class='error help-block'>{{ $errors->first('descriptions') }}</span>
              </div>
          </div>
          <div class="form-group col-lg-11">
            <label class="col-sm-2 col-lg-2 control-label" style="text-align: right;">Blog Image <i class="red">*</i></label>
            <div class="col-sm-8 col-lg-8 controls">
               <div class="fileupload fileupload-new" data-provides="fileupload">
                  ...
                  <div>
                     ...
                     <span class="fileupload-exists">Change</span>                         
                        <input type="file"  name="blog_image" id="image" class="file-input news-image validate-image" data-rule-required="true">
                ...
                <div id="err_payment_receipt"></div>  
               </div>
            </div>
          </div>
          <div class="form-group col-lg-11">
...
<script src="//cdn.ckeditor.com/4.10.0/full/ckeditor.js"></script>
 <!--  <script src="{{ url('/front/js/ckeditor.js') }}"></script>     -->
