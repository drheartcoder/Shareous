            ...
            <table class="table table-advance" id="blog_table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{isset($object['blog_category']['0']['category_name'])? ucfirst($object['blog_category']['0']['category_name']):''}}</td>
                  <td>{{isset($object['description'])? strip_tags(ucfirst(str_limit($object['description'], 100))):''}}</td>
                  <td>
                    @if($object['status']!='1')
                  ...
                  <td>
                    <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="View" href="{{url($module_url_path.'/view/'.base64_encode($object['id']))}}"><i class="fa fa-eye"></i>
                    </a>
