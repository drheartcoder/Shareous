      ...
      <form name="validation-form" id="validate_form" method="POST" class="form-horizontal" action="{{url($module_url_path)}}/store" enctype="multipart/form-data"  files ="true">
        {{csrf_field()}}
          <div class="form-group col-lg-11">
           <label class="col-sm-2 col-lg-3 control-label" for="page_title" style="text-align: right;">Blog Category Name <i class="red">*</i></label>
           <div class="col-sm-5 col-lg-5 controls">
            <input type="text" name="category_name" class="form-control" value="{{old('category_name')}}" data-rule-required="true" data-rule-maxlength="255"  placeholder="Blog Category Name">
