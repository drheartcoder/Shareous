                        ...
                        <form name="validation-form" id="validate_form" method="POST" class="form-horizontal" action="{{url($module_url_path).'/update/'.$id}}" enctype="multipart/form-data"  files ="true">
                            ...
                            <div class="form-group col-lg-11">
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <input type="text" name="coupon_code" class="form-control" value="{{isset($coupon['coupon_code']) ? $coupon['coupon_code']:''}}" data-rule-required="true" data-rule-minlength="9" data-rule-maxlength="10"  placeholder="Enter Coupon Code">
                            ...
                            <div class="form-group col-lg-11">
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <textarea name="descriptions" data-rule-maxlength="500" class="form-control" data-rule-required="true"> {{isset($coupon['descriptions']) ? $coupon['descriptions']:''}}</textarea>
                            ...
                            <div class="form-group col-lg-11">
                                ...
                                <div class="col-sm-8 col-lg-5 controls">
                                    <select class="form-control" tabindex="1" name="discount_type" id="discount_type" data-rule-required="true">
                                        <option value="1" <?php if($coupon['discount_type'] == '1'){ ?> selected <?php } ?>> Fix Amount </option>
                                        <option value="2" <?php if($coupon['discount_type'] == '2'){ ?> selected <?php } ?>> Percentage </option>                
                                    </select>
                            ...
                            <div class="form-group col-lg-11" id="fix-amount" >
                                ...
                                <div class="col-sm-5 col-lg-5 controls" >
                                    <input type="text" name="fix-amount" class="form-control" value="{{isset($coupon['discount']) ? $coupon['discount']:''}}" data-rule-required="true" min="1" data-rule-maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Enter fix discount amount">
                            ...
                            <div class="form-group col-lg-11"  id="percentage" style='display:none;'>
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <div class="input-group">  
                                        <input type="text" name="percentage" class="form-control" value="{{isset($coupon['discount']) ? $coupon['discount']:''}}" data-rule-required="true"   pattern="^(?!0+$)\d{1,2}(\.\d{0,2})?$" data-native-error="Please enter valid input" onkeypress="return isNumberKey(event)" placeholder="Enter discount in percentage">
                            ...
                            <div class="form-group col-lg-11">
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <div class="input-group">  
                                        <input type="text" id="datepicker" name="global_expiry" class="form-control" data-rule-required="true" data-rule-date="true" data-msg-date="The field global expiry must be a date." value="{{isset($coupon['global_expiry']) ? date('m/d/Y',strtotime($coupon['global_expiry'])):''}}" placeholder="Enter global expiry" readonly="readonly" style="cursor: pointer;">
                            ...
                            <div class="form-group col-lg-11">
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <div class='input-group date' id='datetimepicker3'>
                                        <input type="text" name="auto_expiry" class="form-control" value="{{isset($coupon['auto_expiry']) ? $coupon['auto_expiry']:''}}" data-rule-required="true" placeholder="Enter auto expiry" readonly="" style="cursor: pointer;">
                            ...
                            <!-- <div class="form-group col-lg-11">
                                ...
                                <div class="col-sm-5 col-lg-5 controls">
                                    <div class="radio-btns-new">    
                                        <div class="radio-btn">
                                            <input id="min_amount" name="coupon_type" type="radio" data-rule-required="true" <?php if($coupon['coupon_use'] == '1'){ ?> checked <?php } ?> value="1">
                                            <label for="min_amount">Min. Amount</label>
                                            <div class="check"></div>
                                        </div>
                                        <div class="radio-btn">
                                            <input id="first_time_user" name="coupon_type" type="radio" data-rule-required="true" <?php if($coupon['coupon_use'] == '2'){ ?> checked <?php } ?> value="2">
                                            <label for="first_time_user">User First Time</label>
                                            <div class="check"></div>
                                        </div> 
                                        <div class="radio-btn">
                                            <input id="both" name="coupon_type" type="radio" data-rule-required="true" <?php if($coupon['coupon_use'] == '3'){ ?> checked <?php } ?> value="3">
