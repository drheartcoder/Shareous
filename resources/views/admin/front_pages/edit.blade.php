  ...
  <div class="row">
    <div class="col-sm-12">
      ...
      <!-- <div class="form-group col-lg-11">
       ...
       <div class="col-sm-7 col-lg-7 controls">
        <input type="text" name="slug" class="form-control" value="{{isset($object['page_slug']) ? ucfirst($object['page_slug']):''}}" data-rule-required="true" data-rule-maxlength="255"  placeholder="{{$module_title or ''}} Slug">
