...
<div id="main-content">
  ...
  <div class="row">
        ...
        <div class="box-content">
          ...
          <form name="frm_manage" id="frm_manage" method="POST" class="form-horizontal" action="{{url($module_url_path)}}/multi_action">
            ...
            <div class="table-responsive" style="border:0">
              <table class="table table-advance" id="front_pages_table">
                <thead>                       
                  <tr>
                    <th style="width:18px"> 
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{isset($object['page_title'])? ucfirst($object['page_title']):''}}</td>
                    {{-- <td>{{isset($object['page_slug'])? $object['page_slug']:''}}</td> --}}
                    <td>{{isset($object['page_description'])? substr(strip_tags($object['page_description']), 0, 50):''}}</td>
    ...
    <script type="text/javascript">
      ...
      var oTable = $('#front_pages_table').dataTable({
      "aoColumnDefs": [
      {
        "bSortable": false,
