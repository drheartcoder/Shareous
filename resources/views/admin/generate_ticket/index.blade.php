  ...
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-content">
        ...
        <form name="validation-form" id="site-setting-form" method="POST" class="form-horizontal" action="{{url($module_url_path.'generate_ticket/store_ticket')}}" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="form-group fent-color">
          ...
          <div class="form-group">
            <label class="col-sm-3 col-md-3 col-lg-2 control-label">Attach File</label>
              <div class="col-sm-9 col-md-9 col-lg-6 controls">
...
<script type="text/javascript">
  ...
  $("#user_id").on('change', function(){
        ...
        var temp_url        = module_url_path+'generate_ticket/get_user_type';
        ...
        if(user_id != '')
        {
          $.ajax({
            ...
            url : module_url_path+'generate_ticket/get_user_type',
            type : 'POST',
