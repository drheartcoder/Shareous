...
<div id="main-content">
        ...
        <div class="box-content">
          ...
          <form name="frm_manage" id="frm_manage" method="POST" class="form-horizontal" action="{{url($module_url_path)}}/multi_action">
           ...
           <div class="table-responsive" style="border:0">
            <table class="table table-advance" id="notifications_table">
              <thead>                       
                <tr>
                  <th style="width:18px"> 
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{isset($object['template_text'])? ucfirst(substr($object['template_text'], 0,100)).'...':''}}</td>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      var oTable = $('#notifications_table').dataTable({
      "aoColumnDefs": [
                        { 
                          "bSortable": false, 
                          "aTargets": [0,4] // <-- gets last column and turns off sorting
                         }, 
