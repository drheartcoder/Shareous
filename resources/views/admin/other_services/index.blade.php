      ...
      <div class="box">
        ...
        <div class="box-content">
          ...
          <div class="btn-toolbar pull-right">
            <div class="btn-group">
              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Add New" href="{{url('/')}}/{{$admin_panel_slug}}/other_services/create"><i class="fa fa-plus"></i></a>
              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Refresh" href="{{url('/')}}/{{$admin_panel_slug}}/other_services"><i class="fa fa-refresh"></i></a>
          ...
          <form name="frm_manage" id="frm_manage" method="POST" class="form-horizontal" action="{{url($module_url_path)}}/multi_action">
           {{ csrf_field() }}
            ...
            <div class="table-responsive" style="border:0">
              <table class="table table-advance" id="services_table">
                <thead>                       
                  <tr>
