...
<div id="main-content">
      ...
      <div class="box">
        ...
        <div class="box-content">
          ...
          <div class="btn-toolbar pull-right">
            <div class="btn-group">
              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Add New" href="{{url('/')}}/{{$admin_panel_slug}}/query_type/create"><i class="fa fa-plus"></i></a>
              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Refresh" href="{{url('/')}}/{{$admin_panel_slug}}/query_type"><i class="fa fa-refresh"></i></a>
              <a class="btn btn-circle btn-to-danger btn-bordered btn-fill show-tooltip" title="Inactive multiple records" href="javascript:void(0)" onclick="javascript : return check_multi_action('frm_manage','deactivate');"><i class="fa fa-lock"></i></a>
              <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip" title="Active multiple records" href="javascript:void(0)" onclick="javascript : return check_multi_action('frm_manage','activate');"><i class="fa fa-unlock"></i></a>
          ...
          <form name="frm_manage" id="frm_manage" method="POST" class="form-horizontal" action="{{url($module_url_path)}}/multi_action">
           {{ csrf_field() }}
            ...
            <div class="table-responsive" style="border:0">
              <table class="table table-advance" id="query_type_table">
                <thead>                       
                  <tr>
                ...
                <tbody>
                 ...
                 <?php $date=get_added_on_date($object['created_at']); ?>
                  ...
                  <tr>
                    ...
                    <td>{{isset($object['query_type'])? ucfirst($object['query_type']):''}}</td>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      var oTable = $('#query_type_table').dataTable({
      "aoColumnDefs": [
                        { 
                          "bSortable": false, 
                          "aTargets": [0,3,4] 
