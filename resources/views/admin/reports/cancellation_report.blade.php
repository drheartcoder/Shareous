    ...
    <div class="col-md-12">
      <div class="box {{theme_color()}}">
        ...
        <div class="box-content">   
         ...
         <form name="frm-manage" id="frm-manage" method="get" action="{{$module_url_path}}/cancellation"  class="form-inline" >
              ...
              <div class="form-group" >
                ...
                <a href="{{$module_url_path}}/cancellation" class="btn btn-default">Reset </a>
              </div>
        ...
        <form name="export" id="frm-export"  action="{{$module_url_path}}/cancellation_export" method="get">
...
<script type="text/javascript">
    ...
    var temp_url            = module_url_path+'/load_cancellation_data';
