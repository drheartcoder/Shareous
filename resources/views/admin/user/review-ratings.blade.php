...
<div id="main-content">
  ...
  <div id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <i class="fa {{$section_icon}}"></i>
        <a href="{{url($module_url_path)}}"> {{$section_name or ''}}</a>
        <span class="divider"><i class="fa fa-angle-right"></i></span>
      </li>
    ...
    <div class="col-md-12">
      <div class="box {{theme_color()}}">
        ...
        <div class="box-content">
         <form name="frm-manage" id="frm-manage" method="get" action="{{$sub_module_url_path}}"  class="form-inline" >
              ...
              <div class="form-group" >
                ...
                <a href="{{$sub_module_url_path}}" class="btn btn-default">Reset </a>
              </div>
     ...
     <form name="frm_manage" id="frm_manage" method="POST" class="form-horizontal" action="{{$module_url_path}}/check_review_action">
              {{ csrf_field() }}
              {{-- <div class="col-md-10">
...
<script type="text/javascript"> 
    ...
    var temp_url        = module_url_path+'/load_review_ratings';
    ...
    table_module        = $('#myTable').DataTable({
      ...
      ajax: 
      {
        ...
        'url'     : temp_url,
        'data'    : {'user_id':user_id,property_name : property_name}
      },
       "columnDefs": [
