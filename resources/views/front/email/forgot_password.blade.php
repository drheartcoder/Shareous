                        ...
                        <table style="margin-bottom: 0; margin-top: 33px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td style="color: #333333; font-size: 16px; padding: 0 30px;">
                                Hello <span style="color:#f50001;font-family: 'Latomedium',sans-serif;">User,</span>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr><td class="listed-btn"><a target='_blank' href="{{ URL::to('password_reset',$token,false) }}" class='link2' style='color:#ffffff;'>Reset Your Password</a></td></tr>
                            <tr>
                              <td height="40"></td>
                            </tr>
                            <tr>
