...
<form action="{{ $module_url_path }}/store_step2" method="post" name="frm_post_property_step2" enctype="multipart/form-data" id="frm_post_property_step2">
    {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="update-pro-img-main">
                            <div class="update-pro-head rispon">Uploaded Images</div> 
                            <div class="lab_img" id="lab_1">
                                <div class="col-sm-12 col-lg-12 col-lg-12" style="float:right;">
                                    <span>
                                        <a href="javascript:void(0);" id='remove_project' class="remove_project" style="display:none;" ><span class="glyphicon glyphicon-minus-sign" style="font-size:20px;"></span></a>
                                    </span>
                                </div>
                                <div class="" id="add_lab_div">
                                    <div class="add_pht upload-pic loc_add_pht" id="div_blank" onclick="return addpictures(this)"  style="height: 120px;width: 120px; float: left;"> 
                                        <img src="{{ url('/') }}/front/images/plus-img-2.jpg" alt="user pic"  style="width:100%;heightght:100%;" />
                                    </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6">
                                            <div class="user_box1 add">
                                                <div class="check-box inline-checkboxs singup-tp top-less">
                                                    <input id="{{ isset($aminities['aminity_name']) ? $aminities['aminity_name'] : '' }}" value="{{ $aminities['id'] or '' }}" name="aminities[]" class="filled-in aminities-chk" slug="<?php echo strtolower(trim(str_slug($aminities['aminity_name'], '-'))); ?>" type="checkbox" />
                                                ...
                                                <input style="display:none;" type="text" name="<?php echo trim(str_slug($aminities['aminity_name'], '-')); ?>" id="<?php echo trim(str_slug($aminities['aminity_name'], '-')); ?>" maxlength="100" data-rule-maxlength="100" placeholder="<?php echo ucwords($aminities['aminity_name']); ?>" >
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                @else
                                    <div class="col-sm-12 col-md-12 col-lg-12">{{ 'No Aminities are present' }}</div>
                                @endif
                    ...
                    <?php $property_slug = get_property_type_slug($arr_property['property_type_id']); ?>
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        @if($property_slug != 'warehouse' && $property_slug != 'office-space')
                            <div class="sleeping-srrangement-main margin">
                                ...
                                <div class="row">
                                    <div class="minu-pluss-wrapper"> 
                                        <div id="monthly_date_div" class="clone-datepicker-section">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <div class="row ">
                                                    <div class="col-sm-5 col-md-5 col-lg-5">
                                                        <div class="comments-title-bed-main date-width">
                                                            <div class="form-group mrgin-extra">
                                                                <input id="from-datepicker" name="from_date[]" type="text" class="datepicker-input from_date" placeholder="From Date" readonly=""/>
                                                    ...
                                                    <div class="col-sm-5 col-md-5 col-lg-5" id="to-datepicker-div">
                                                        <div class="comments-title-bed-main date-width">
                                                            <div class="form-group mrgin-extra">
                                                                <input id="to-datepicker" name="to_date[]" type="text"  class="datepicker-input to_date" placeholder="To Date" readonly=""/>
                                                                <span class="calendar-icon"><i class="fa fa-calendar"></i></span>
                                        ...
                                        <div class="button-plus-step-2-wraper twwo">
                                            <input type="button" name="btn_add_unavailibility" id="btn_add_unavailibility" value="+">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="price-per-night-blo no-border" id="add-rule-div">
                                ...
                                <div class="ad-rul-block-main">
                                    <div class="form-group">
                                        <div class="ad-rul-block"><a onclick="addRules()">Add Rules</a></div>
                            ...
                            <div class="price-per-night-blo no-border" id="edit-rule-div" style="display:none">
                                ...
                                <div class="ad-rul-block-main">
                                    <div class="form-group">
                                        <div class="ad-rul-block"><a onclick="updateRules()">Update Rules</a></div>
                            ...
                            <div id="property-step2-div">
                                <div class="price-per-night-blo no-padding" id="rules-div">
                                    ...
                                    @if(isset($arr_rules) && sizeof($arr_rules)>0)
                                        @foreach($arr_rules as $rules)
...
<script type="text/javascript">
    $(function () {
        ...
        $("#from-datepicker").datepicker({
            ...
            $('#to-datepicker').datepicker('setStartDate', minDate);
        });
        ...
        $("#to-datepicker").datepicker({
            ...
            $('#from-datepicker').datepicker('setEndDate', maxDate);
        });
    ...
    $("#btn_add_property_step2").click(function()
    {
        ...
        if (imagecount < 3) 
        {
            ...
            {
            //$("#err_other_images").html('');
        });
            flag = 0;
        }
        if(imagecount>6)
        {
            $('#err_other_images').html('Please select max 6 images of the property.');
            $(".add_pht").focus();
            $(".add_pht").change(function(){/*$("#err_other_images").html('');*/});
            flag = 0;
        }
    ...
    $(".clone-datepicker-section").each(function(){
        ...
        if($.trim(from_date)!='' && $.trim(to_date)!='')
        {
        //  alert($.inArray($.trim(from_date)+' - '+$.trim(to_date), temp_arr)+"//"+$.inArray($.trim(from_date), temp_from_arr)+"//"+$.inArray($.trim(to_date), temp_to_arr));
   ...
   /* $("#btn_add_property_step2").click(function()
   {
       var no_of_img = $(".uploaded_img").length;
       var flag = 1;
      $(".clone-datepicker-section").each(function(){            
           var from_date  =  $(this).find('.from_date').val();
           var to_date   =  $(this).find('.to_date').val();
     ...
     /*  if(no_of_img < 6)
       {
           $('#err_uploaded_img').html("Please upload min 6 images of the property.");
   ...
   {       
       ...
       {
           $("#property_images").val('');
           showAlert('sorry' + ', ' + file[0]['name'] + ' size has crossed the size limit, max size allowed is 5mb.',"error");
       }
       else
       {
           response = validate_image(this.files);
   
           if(response == false)
           {        
              $("#property_images").val('');
              showAlert('sorry' + ',' + file[0]['name'] + 'is invalid,allowed extensions are: jpeg , jpg , png',"error");
           }
       }
   ...
   {
          var file_data       = $("#property_images").prop("files")[0];
          var enc_property_id = $("#enc_property_id").val();
          var token           = '{{ csrf_token() }}'; 
          var data            = new FormData();
          data.append('_token', token);
   ...
   function validate_image(file)
   {
    ...
    $("#btn_add_unavailibility").on('click',function(){
        ...
        {            
           ...
           //$('.clone-datepicker-section').last().append('<input type="button" onclick="removeUnavailability()" name="btn_remove_unavailibility" id="btn_remove_unavailibility" value="-">');
        }
        else
        {
            return false;
    ...
    function removeUnavailability()
    {
        ...
        {
            swal("You can't remove last record");
        }
