        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
                     ...
                     @if(isset($arr_review_rating['data']) && count($arr_review_rating['data'])>0)
                     @foreach($arr_review_rating['data'] as $booking)                     
                        <div class="list-vactions-details user-spaces short-img">
                            ...
                            <div class="content-list-vact">
                                ...
                                <!-- <div class="star-reviews-list pull-left">
                                    {!!  isset($booking->rating) ? $booking->rating:'' !!}
                                </div> -->                                
                                ...
                                <!-- <div class="review-cont"> {{isset($booking->total_property_reviews) ? $booking->total_property_reviews:''}} reviews</div> -->
                                  
                                <div class="review-discri-after-star">
                                     {{ isset($booking->message) ? $booking->message : '' }}          
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        </div>                    
