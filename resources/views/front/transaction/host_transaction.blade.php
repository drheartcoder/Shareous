                ...
                <form action="{{ $module_url_path }}/search" method="get" name="frm_search_transaction" id="frm_search_transaction">
                    ...
                    <div class=" col-sm-6 col-md-3 col-lg-3">   
                       <div class="transac-search"> 
                         <button class="btn-cancel tran-sear" type="submit" style="min-width: 40px;"><i class="fa fa-search"></i></button>
                                    ...
                                    <div class="transactions-table table-responsive">
                                        ...
                                        <div class="table">                                           
                                            ...
                                            <div class="table-row heading">
                                                ...
                                                <div class="table-cell sort-option" data-type="payment_type" data-sort="{{$sort_by}}">Payment For <i class="fa fa-sort"></i></div>
                                            ...
                                            @foreach($arr_transaction['data'] as $data)
                                                <?php 
                                                    ...
                                                    if(isset($data['payment_type']) && $data['payment_type'] == 'booking') {
                                                        if($currency_code == 'INR') {
                                                            ...
                                                            $amount = isset($data['amount']) ? number_format(currencyConverter($currency_code, 'INR', $data['amount']),'2','.','' ) : '';
                                                        }
                                                ...
                                                <div class="table-row">
                                                    ...
                                                    <div class="table-cell tabe-discrip short date">{{ $transaction_for }}</div>
                                                    ...
                                                    <div class="table-cell compli-green reviews-rating">{{isset($data['payment_type']) ? ucfirst($data['payment_type']) : '-' }}</div>
