              ...
              <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr >
                  <td style=" color: #333;font-size: 17px; text-align: center;">
                    <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="text-align:center;"><a href="{{url('/')}}"><img src="{{url('/web_admin/images/logo-inner.png')}}" class="logo-bg"  alt="logo"/></a></td>
                    ...
                    <table style="margin-bottom: 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td style="font-size:15px;background:#333; text-align: center; color: rgb(255, 255, 255); padding: 15px;">
                          Copyright &copy; {{date('Y')}} <a href="{{url('/')}}" style="color:#fff;">{{config('app.project.name')}}</a>. All Right Reserved.  <a href="{{url('/terms-and-conditions')}}" style="color:#fff;">Terms &amp; Conditions</a>
                        </td>
