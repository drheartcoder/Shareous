...
<div id="breadcrumbs">
   <ul class="breadcrumb">
      ...
      <li >  
      <a href="{{$previous_page_url}}">{{ isset($previous_page_title)?$previous_page_title:"" }}</a>
      </li>
            <span class="divider">
      <i class="fa fa-angle-right">
      </i>
                           ...
                           {{ csrf_field() }}
                             <div class="form-group">
                               <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                                  ...
                                  <button type="button" onclick="location.href='{{ $module_url_path }}/approve'" class="btn btn-cancel"> <i class="fa fa-arrow-left"></i> Back</button>
                               </div>
                            </div>
                        </form>
                     </div>
...
function accept(id)
{
  swal({
    title: "Are you sure",
    text: " You want to approve verification of user?",
    type: "warning",
...
function reject(id)
{
  swal({
    title: "Are you sure",
    text: "You want to reject verification of user?",
    type: "warning",
    showCancelButton: true,
    confirmButtonClass: "btn-danger",
    confirmButtonText: "Confirm",
