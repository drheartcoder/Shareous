    ...
    <div class="col-md-12">
      <div class="box {{theme_color()}}">
        ...
        <div class="box-content">         
          <form name="frm-manage" id="frm-manage" method="get" action="{{$module_url_path}}/reject_request"  class="form-inline" >
                ...
                <div class="form-group" style="margin-top:6px;">
                  ...
                  <input type="text"  placeholder="Requested On"  id="requested_on" name="requested_on" class="form-control"  value="{{ trim($requested_on)}}" class="date-picker form-control" >
                </div>
                &nbsp;&nbsp;
                <div class="form-group">
                  <input id="submit_filter" class="btn btn-primary same_search" type="submit" value="Search" name="btn_search"> &nbsp;
                  <a href="{{$module_url_path}}/reject_request" class="btn btn-default">Reset </a>
                </div>
...
<script type="text/javascript"> 
 $("#requested_on").datepicker({ dateFormat: 'yy-mm-dd' });
    ...
    var temp_url        = module_url_path+'/load_reject_data';
